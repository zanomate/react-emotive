...
export function arrow(params: ts.ParameterDeclaration[], returnType: ts.TypeNode | undefined, body: ts.ConciseBody) {
    return ts.createArrowFunction([], [], params, returnType, undefined, body);
}

export function param(id: ts.Identifier, type: ts.TypeNode | undefined, dotDotDot: boolean = false) {
